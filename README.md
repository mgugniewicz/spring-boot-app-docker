...
This is simple application generated by spring boot initializer(https://start.spring.io/).
...
simple-app		   0.0.1-SNAPSHOT      e74e5fa15b94        17 minutes ago      144 MB
...
task buildDocker(type: Docker) {
	baseImage = 'develar/java:latest'
	push = project.hasProperty('push')
	tag = '10.32.15.221:5000/simple-app'*
	addFile {
		from jar
		rename {'simple-app-docker-plugin.jar'}
